        ...
        >
          ...
          <TouchableOpacity
              ...
              onPress={()=>{
                ...
                AsyncStorage.setItem('User', JSON.stringify(NewGlobalStore.user));
                AsyncStorage.setItem('PassWord', JSON.stringify(NewGlobalStore.passWord));
                AsyncStorage.setItem('ServerParameters', JSON.stringify(NewGlobalStore.serverParameters));
                AsyncStorage.setItem('LandingState', JSON.stringify(NewGlobalStore.landingState));
